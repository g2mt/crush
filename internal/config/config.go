...
type Options struct {
	...
	SystemPromptPath     string      `json:"system_prompt_path,omitempty" jsonschema:"description=Path to a file containing a custom system prompt for the coder agent,example=.crush/system-prompt.md"`
